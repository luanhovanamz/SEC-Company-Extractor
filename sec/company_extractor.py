...
class CompanyExtractor:
    ...
    def _extract_address(
        ...
        # Find state immediately before address label.
        state_index = -1

        for index in range(
            label_index - 1,
            max(-1, label_index - 15),
            -1,
        ):
        ...
        # Find city immediately before state.
        city = ""
        city_index = -1
        ...
        # Find business address before city.
        address_parts = []
